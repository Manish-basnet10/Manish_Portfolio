...
const socialLinks = [
  ...
  {
    label: "WhatsApp",
    href: "https://wa.me/9779869417950",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <div className="container-max">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left scroll-animate">
            ...
            >
              Software Engineer · Full Stack Developer · Tech Problem Solver
            </p>
            ...
            <p className={`text-sm sm:text-base leading-relaxed max-w-lg mx-auto lg:mx-0 mb-7 ${mutedText}`}>
              I'm a passionate software engineer specialising in full-stack web development,
              cloud infrastructure, and scalable system design. I love turning complex problems
              into elegant, user-friendly solutions — from pixel-perfect frontends to robust
              backend architectures. Currently building things that matter and looking for
              exciting opportunities to grow and collaborate.
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 mb-8 flex-wrap">
              <a
                href="#" // TODO: Replace with your resume PDF link
                ...
                aria-label="View Manish's resume (PDF)"
                target="_blank"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Hire Manish via WhatsApp"
              >
                Hire Me
              </a>
            </div>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-3 flex-wrap">
              {socialLinks.map((s) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label={`Manish Basnet on ${s.label}`}
            ...
            <div className="relative">
              ...
              >
                <img
                  ...
                  alt="Manish Basnet — Software Engineer and Full Stack Developer"
